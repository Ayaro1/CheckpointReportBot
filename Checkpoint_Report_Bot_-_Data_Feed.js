// ==UserScript==
// @id             iitc-plugin-checkpoint-report-bot-data-feed
// @name           IITC plugin: Checkpoint Report Bot - Data Feed
// @category       Checkpoint Report Bot
// @author         Ayaro
// @version        0.1.20210228.0757
// @namespace      https://github.com/Ayaro1/CheckpointReportBot
// @updateURL      https://github.com/Ayaro1/CheckpointReportBot/raw/master/Checkpoint_Report_Bot_-_Data_Feed.js
// @downloadURL    https://github.com/Ayaro1/CheckpointReportBot/raw/master/Checkpoint_Report_Bot_-_Data_Feed.js
// @description    Data feed for the Checkpoint Report Bot. Also shows avarage MU per CP from elapsed CP's and current MU lead.
...
// Credits to hansolo669 for creating the originial plugin

function wrapper(plugin_info) {
  build="0.1.20201219.0721";
  var nickname = window.PLAYER.nickname;
  var faction = PLAYER.team
  ...
  var setup = function() {
    ...
    function regionScoreboardSuccess(data,dlg,logscale) {
      ...
      $.ajax({
        url: 'https://crb.ayaro.eu/CRBInputA.php',
        type: 'post',
        data: {regioninfo:data}
      });
